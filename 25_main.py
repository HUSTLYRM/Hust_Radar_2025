...
from Lidar.Lidar_25 import Process_Lidar
...
if __name__ == '__main__':
    video_path = "./data/华科vs哈工大round1_原视�?.avi" # 请改�?/path/to/video.avi
    ...
    today = time.strftime("%Y%m%d", time.localtime()) # 今日日期，例�?2024�?5�?6日则�?20240506
            ...
            if infer_result is not None:
                ...
                if results is not None:
                    ...
                    for result in results:
                        ...
                        new_xywh_box = main_utilities.get_new_box(xywh_box)
                        center = converter.detection_main(new_xywh_box,stamp,point_cloud=pc_all)
                    ...
                    if is_debug:
                        # 可视化
                        new_result_img = cv2.resize(result_img, (600, 320))
                        cv2.imshow("result", new_result_img)
