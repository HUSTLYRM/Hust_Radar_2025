            ...
            if infer_result is not None:
                ...
                if results is not None:
                    ...
                    for result in results:
                        ...
                        # # # 如果聚类结果为空，则用中值取点
                        if len(location):
                            center = converter.get_center_mid_distance(box_pcd)# TODO
                        ...
                        # 将点转到赛场坐标系下
                        field_xyz = converter.camera_to_field(location)
                        # 计算赛场坐标系下的距离
                        ...
                        # 将结果打包
                        carList_results.append([track_id , carList.get_car_id(label) , xywh_box , 1 , location , field_xyz])# 提取location前两个元素
